...
<?php if(!Registry::get('username')) { ?>
    ...
    <div id="logincontainer" class="container">
        ...
        <form name="login" action="login.php" method="post" class="form-signin">
            ...
            <input type="text" class="input-block-level" name="username" placeholder="<?php print $text_email; ?>" <?php if(isset($_GET['username'])) { ?>value="<?php print $_GET['username']; ?>"<?php } ?> required autofocus>
        ...
        <div id="compatibility" class="well well-large">
            <p><?php print LOGIN_SCREEN_TEXT; ?></p>
        </div>
...
<!-- <?php print LOGIN_HELPER_PLACEHOLDER; ?> -->
