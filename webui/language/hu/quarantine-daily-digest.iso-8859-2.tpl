...
<p>Önnek <?php print $n; ?> db levele (<?php print $total_size; ?> byte) van a karanténban a jelenlegi email házirendnek megfelelõen.</p>

<p>Kérjük, hogy rendszeresen nézze át a karantént, mert ott csak korlátozott ideig kerülnek megõrzésre a levelek, azután automatikusan törlõdnek.</p>
