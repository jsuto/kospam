...
<form action="index.php?route=quarantine/quarantine" name="aaa0" method="get" onsubmit="fix_search(); return false;">
   ...
   <table border="0">
     <tr>
      <td><?php print $text_date; ?>:</td><td><input type="text" name="date" id="date" length="11" size="11" value="<?php print $date; ?>" /></td>
      <td><?php print $text_from; ?>:</td><td><input type="text" name="from" value="<?php print $from; ?>" /></td>
      <td><?php print $text_to; ?>:</td><td><input type="text" name="to" value="<?php print $to; ?>" /></td>
...
<?php foreach($searchterms as $term) { ?>
            <option value="index.php?route=quarantine/quarantine&<?php print $term['term']; ?>"<?php if(strncmp($_SERVER['QUERY_STRING'], "route=quarantine/quarantine&" . $term['term'], strlen("route=quarantine/quarantine&" . $term['term'])) == 0){ ?> selected="selected"<?php } ?>><?php $q1 = 0; parse_str($term['term'], $x1); if($x1['subj']){ print "subj: " . $x1['subj']; $q1++; } if($x1['from']){ if($q1) print ", "; print "from: " . $x1['from']; $q1++; } if($x1['to']){ if($q1) print ", "; print "to: " . $x1['to']; $q1++; } if($x1['date']){ if($q1) print ", "; print "date: " . $x1['date']; $q1++; } if($x1['hamspam']){  if($q1) print ", "; print $x1['hamspam']; } ?></option>
<?php } ?>
         </select>
      </td>
     </tr>
...
<div id="pagenav">
   <?php if($page > 0){ ?><a href="index.php?route=quarantine/quarantine&amp;page=0&amp;to=<?php print $to; ?>&amp;from=<?php print $from; ?>&amp;subj=<?php print $subj; ?>&date=<?php print $date; ?>&hamspam=<?php print $hamspam; ?>&amp;sort=<?php print $sort; ?>&amp;order=<?php print $order; ?>" class="navlink"><?php } ?> &laquo; <?php if($page > 0){ ?></a><?php } ?>
   <?php if($page > 0){ ?><a href="index.php?route=quarantine/quarantine&amp;page=<?php print $prev_page; ?>&amp;to=<?php print $to; ?>&amp;from=<?php print $from; ?>&amp;subj=<?php print $subj; ?>&date=<?php print $date; ?>&hamspam=<?php print $hamspam;?>&amp;sort=<?php print $sort; ?>&amp;order=<?php print $order; ?>" class="navlink"><?php } ?> &lsaquo; <?php if($page > 0){ ?></a><?php } ?>
    <?php print $messages[0]['i']; ?> - <?php print $messages[count($messages)-1]['i']; ?>
   <?php if($n > $messages[count($messages)-1]['i']){ ?><a href="index.php?route=quarantine/quarantine&amp;page=<?php print $next_page; ?>&amp;to=<?php print $to; ?>&amp;from=<?php print $from; ?>&amp;subj=<?php print $subj; ?>&date=<?php print $date; ?>&hamspam=<?php print $hamspam;?>&amp;sort=<?php print $sort; ?>&amp;order=<?php print $order; ?>" class="navlink"><?php } ?> &rsaquo; <?php if($n >= $page_len*($page+1) && $n > $page_len){ ?></a><?php } ?>
   <?php if($n > $messages[count($messages)-1]['i']){ ?><a href="index.php?route=quarantine/quarantine&amp;page=<?php print $total_pages; ?>&amp;to=<?php print $to; ?>&amp;from=<?php print $from; ?>&amp;subj=<?php print $subj; ?>&date=<?php print $date; ?>&hamspam=<?php print $hamspam; ?>&amp;sort=<?php print $sort; ?>&amp;order=<?php print $order; ?>" class="navlink"><?php } ?> &raquo; <?php if($page < $total_pages){ ?></a><?php } ?>
</div>
...
<?php foreach ($messages as $message) { ?>
   ...
   <tr valign="top" id="tr_<?php print $message['id'] . "+" . $message['username']; ?>">
      ...
      <td align="center"<?php if(($message['i'] % 2) == 0){ ?> class="odd"<?php } ?>><a href="index.php?route=quarantine/quarantine&user=<?php print $message['username']; ?><?php if(SPAM_ONLY_QUARANTINE == 1) { ?>&hamspam=SPAM<?php } ?>"><?php print $message['username']; ?></a></td>
...
<div id="pagenav">
   <?php if($page > 0){ ?><a href="index.php?route=quarantine/quarantine&amp;page=0&amp;to=<?php print $to; ?>&amp;from=<?php print $from; ?>&amp;subj=<?php print $subj; ?>&date=<?php print $date; ?>&hamspam=<?php print $hamspam; ?>" class="navlink"><?php } ?> &laquo; <?php if($page > 0){ ?></a><?php } ?>
   <?php if($page > 0){ ?><a href="index.php?route=quarantine/quarantine&amp;page=<?php print $prev_page; ?>&amp;to=<?php print $to; ?>&amp;from=<?php print $from; ?>&amp;subj=<?php print $subj; ?>&date=<?php print $date; ?>&hamspam=<?php print $hamspam;?>" class="navlink"><?php } ?> &lsaquo; <?php if($page > 0){ ?></a><?php } ?>
    <?php print $messages[0]['i']; ?> - <?php print $messages[count($messages)-1]['i']; ?>
   <?php if($n > $messages[count($messages)-1]['i']){ ?><a href="index.php?route=quarantine/quarantine&amp;page=<?php print $next_page; ?>&amp;to=<?php print $to; ?>&amp;from=<?php print $from; ?>&amp;subj=<?php print $subj; ?>&date=<?php print $date; ?>&hamspam=<?php print $hamspam;?>" class="navlink"><?php } ?> &rsaquo; <?php if($n >= $page_len*($page+1) && $n > $page_len){ ?></a><?php } ?>
   <?php if($n > $messages[count($messages)-1]['i']){ ?><a href="index.php?route=quarantine/quarantine&amp;page=<?php print $total_pages; ?>&amp;to=<?php print $to; ?>&amp;from=<?php print $from; ?>&amp;subj=<?php print $subj; ?>&date=<?php print $date; ?>&hamspam=<?php print $hamspam; ?>" class="navlink"><?php } ?> &raquo; <?php if($page < $total_pages){ ?></a><?php } ?>
</div>
