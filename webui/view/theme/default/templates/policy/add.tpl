...
<form action="index.php?route=policy/add" name="add" method="post" autocomplete="off" class="form-horizontal">
	...
	<div class="control-group<?php if(isset($errors['name'])){ print " error"; } ?>">
        ...
        <div class="control-group<?php if(isset($errors['deliver_infected_email'])){ print " error"; } ?>">
                ...
                <div class="controls">
                  <input type="checkbox" name="deliver_infected_email" id="deliver_infected_email" <?php if(isset($post['deliver_infected_email'])){ print 'checked="checked"'; } ?> class="checkbox" />
        ...
        <div class="control-group<?php if(isset($errors['silently_discard_infected_email'])){ print " error"; } ?>">
                ...
                <div class="controls">
                  <input type="checkbox" name="silently_discard_infected_email" id="silently_discard_infected_email" <?php if(isset($post['silently_discard_infected_email'])){ print 'checked="checked"'; } ?> class="checkbox" />
        ...
        <div class="control-group<?php if(isset($errors['use_antispam'])){ print " error"; } ?>">
                ...
                <div class="controls">
                  <input type="checkbox" name="use_antispam" id="use_antispam" <?php if(isset($post['use_antispam'])){ print 'checked="checked"'; } ?> class="checkbox" />
        ...
        <div class="control-group<?php if(isset($errors['replace_junk_characters'])){ print " error"; } ?>">
                ...
                <div class="controls">
                  <input type="checkbox" name="replace_junk_characters" id="replace_junk_characters" <?php if(isset($post['replace_junk_characters'])){ print 'checked="checked"'; } ?> class="checkbox" />
        ...
        <div class="control-group<?php if(isset($errors['penalize_images'])){ print " error"; } ?>">
                ...
                <div class="controls">
                  <input type="checkbox" name="penalize_images" id="penalize_images" <?php if(isset($post['penalize_images'])){ print 'checked="checked"'; } ?> class="checkbox" />
        ...
        <div class="control-group<?php if(isset($errors['penalize_embed_images'])){ print " error"; } ?>">
                ...
                <div class="controls">
                  <input type="checkbox" name="penalize_embed_images" id="penalize_embed_images" <?php if(isset($post['penalize_embed_images'])){ print 'checked="checked"'; } ?> class="checkbox" />
        ...
        <div class="control-group<?php if(isset($errors['penalize_octet_stream'])){ print " error"; } ?>">
                ...
                <div class="controls">
                  <input type="checkbox" name="penalize_octet_stream" id="penalize_octet_stream" <?php if(isset($post['penalize_octet_stream'])){ print 'checked="checked"'; } ?> class="checkbox" />
        ...
        <div class="control-group<?php if(isset($errors['store_emails'])){ print " error"; } ?>">
                ...
                <div class="controls">
                  <input type="checkbox" name="store_emails" id="store_emails" <?php if(isset($post['store_emails'])){ print 'checked="checked"'; } ?> class="checkbox" />
        ...
        <div class="control-group<?php if(isset($errors['store_only_spam'])){ print " error"; } ?>">
                ...
                <div class="controls">
                  <input type="checkbox" name="store_only_spam" id="store_only_spam" <?php if(isset($post['store_only_spam'])){ print 'checked="checked"'; } ?> class="checkbox" />
	...
	<div class="form-actions">
        <input type="submit" value="<?php print $text_add; ?>" class="btn btn-primary" /> <a href="index.php?route=policy/list" class="btn"><?php print $text_cancel; ?></a>
	</div>
