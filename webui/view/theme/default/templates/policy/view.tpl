...
<?php if($policy) { ?>
<form class="form-inline" action="index.php?route=policy/edit" method="post">
   <input type="hidden" name="policy_group" value="<?php print $policy_group; ?>" />
   ...
   <div class="row">
      <div class="healthcell"><input type="submit" class="btn btn-primary" value="<?php print $text_edit; ?>" /> <input type="reset" class="btn btn-ok" value="<?php print $text_cancel; ?>" /></div>
   </div>
...
<div class="row">
   <div class="healthcell"><a href="index.php?route=policy/policy"><?php print $text_back; ?></a></div><div class="healthcell"><a href="index.php?route=policy/remove&amp;confirmed=1&amp;policy_group=<?php print $policy_group; ?>" onclick="if(confirm('<?php print $text_remove_policy; ?>: ' + '\'<?php print $policy['name']; ?>\'')) return true; return false;"><?php print $text_remove_this_policy; ?></a></div>
</div>

<?php } else { ?>
   <div class="text-error"><?php print $text_no_such_policy; ?></div>
<?php } ?>
</p>
