...
<h1><?php print $text_quarantine_digest_for1; ?> <?php print $user['email']; ?> <?php print $text_quarantine_digest_for2; ?></h1>

<p><?php print $text_withheld; ?> <?php print $n; ?> <?php print $text_messages; ?> <?php print $text_from_your_mailbox; ?></p>

<p><?php print $text_q_digest_1; ?></p>
<p><?php print $text_q_digest_2; ?></p>
    ...
    <?php $i=0; foreach ($messages as $message) { ?>
         ...
         <tr id="e_<?php print $message['id']; ?>" class="resultrow new">
            ...
            <td id="c6_r<?php print $i; ?>" class="resultcell subject"><a href="<?php print SITE_URL; ?>index.php?route=message/view&amp;id=a<?php print $message['id']; ?>&amp;username=<?php print $user['email']; ?>"><?php print $message['subject']; ?></a></td>
