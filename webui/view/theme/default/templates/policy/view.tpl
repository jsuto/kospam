...
<?php if($policy) { ?>
<form action="index.php?route=policy/edit" method="post">
   <table>
...
<p><a href="index.php?route=policy/policy"><?php print $text_back; ?></a></p>

<p>&nbsp; </p>

<p><a href="index.php?route=policy/remove&amp;policy_group=<?php print $policy_group; ?>"><?php print $text_remove_this_policy; ?></a></p>

<?php } else { ?>
<?php print $text_no_such_policy; ?>
<?php } ?>
</p>
