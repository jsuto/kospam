...
struct _parse_rule config_parse_rules[] =
{
   ...
   { "days_to_retain_history_data", "integer", (void*) int_parser, offsetof(struct __config, days_to_retain_history_data), "30", sizeof(int)},
   { "days_to_retain_quarantine_data", "integer", (void*) int_parser, offsetof(struct __config, days_to_retain_quarantine_data), "14", sizeof(int)},
   ...
   { "mydomains", "string", (void*) string_parser, offsetof(struct __config, mydomains), "", 2*MAXVAL-1},
   ...
   { "psqlhost", "string", (void*) string_parser, offsetof(struct __config, psqlhost), "127.0.0.1", MAXVAL-1},
   { "psqlport", "integer", (void*) int_parser, offsetof(struct __config, psqlport), "5432", sizeof(int)},
   { "psqluser", "string", (void*) string_parser, offsetof(struct __config, psqluser), "clapf", MAXVAL-1},
   { "psqlpwd", "string", (void*) string_parser, offsetof(struct __config, psqlpwd), "", MAXVAL-1},
   { "psqldb", "string", (void*) string_parser, offsetof(struct __config, psqldb), "clapf", MAXVAL-1},
   { "psql_connect_timeout", "integer", (void*) int_parser, offsetof(struct __config, psql_connect_timeout), "2", sizeof(int)},
