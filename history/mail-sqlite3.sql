...
create view hist_out as select smtp.ts, smtp.queue_id, smtp.`to`, smtp.orig_to, clapf.`from`, clapf.`size`, clapf.subject, clapf.result, smtp.relay, smtp.`status` from smtp, clapf where smtp.queue_id = clapf.queue_id2;
