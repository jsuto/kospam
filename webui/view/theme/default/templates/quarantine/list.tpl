...
<div id="pagenav">
   ...
   <?php if($n >= $page_len*($page+1) && $page < $total_pages-1){ ?><a href="index.php?route=quarantine/quarantine&amp;page=<?php print $next_page; ?>&amp;user=<?php print $username; ?>&amp;from=<?php print $from; ?>&amp;subj=<?php print $subj; ?>&hamspam=<?php print $hamspam;?>&amp;sort=<?php print $sort; ?>&amp;order=<?php print $order; ?>" class="navlink"><?php } ?> &rsaquo; <?php if($n >= $page_len*($page+1) && $n > $page_len){ ?></a><?php } ?>
   <?php if($page < $total_pages-1){ ?><a href="index.php?route=quarantine/quarantine&amp;page=<?php print $total_pages-1; ?>&amp;user=<?php print $username; ?>&amp;from=<?php print $from; ?>&amp;subj=<?php print $subj; ?>&hamspam=<?php print $hamspam; ?>&amp;sort=<?php print $sort; ?>&amp;order=<?php print $order; ?>" class="navlink"><?php } ?> &raquo; <?php if($page < $total_pages){ ?></a><?php } ?>
</div>
...
<div id="pagenav">
   ...
   <?php if($page > 0){ ?><a href="index.php?route=quarantine/quarantine&amp;page=<?php print $prev_page; ?>&amp;user=<?php print $username; ?>&amp;from=<?php print $from; ?>&amp;subj=<?php print $subj; ?>&hamspam=<?php print $hamspam;?>" class="navlink"><?php } ?> &lsaquo; <?php if($page > 0){ ?></a><?php } ?>
    <?php print $messages[0]['i']; ?> - <?php print $messages[count($messages)-1]['i']; ?>
   <?php if($n >= $page_len*($page+1) && $page < $total_pages-1){ ?><a href="index.php?route=quarantine/quarantine&amp;page=<?php print $next_page; ?>&amp;user=<?php print $username; ?>&amp;from=<?php print $from; ?>&amp;subj=<?php print $subj; ?>&hamspam=<?php print $hamspam;?>" class="navlink"><?php } ?> &rsaquo; <?php if($n >= $page_len*($page+1) && $n > $page_len){ ?></a><?php } ?>
   <?php if($page < $total_pages-1){ ?><a href="index.php?route=quarantine/quarantine&amp;page=<?php print $total_pages-1; ?>&amp;user=<?php print $username; ?>&amp;from=<?php print $from; ?>&amp;subj=<?php print $subj; ?>&hamspam=<?php print $hamspam; ?>" class="navlink"><?php } ?> &raquo; <?php if($page < $total_pages){ ?></a><?php } ?>
</div>
