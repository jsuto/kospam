...
<p>
   ...
   <?php if($id[0] == 's') { ?><a href="index.php?route=quarantine/train&amp;id=<?php print $id; ?>&amp;user=<?php print $username; ?>&amp;page=<?php print $page; ?>&amp;from=<?php print $from; ?>&amp;subj=<?php print $subj; ?>&hamspam=<?php print $hamspam; ?>"><?php print $text_train_and_deliver_as_ham; ?></a><?php } ?>
</p>
